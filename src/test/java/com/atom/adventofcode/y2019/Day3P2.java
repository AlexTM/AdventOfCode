...
import com.atom.adventofcode.y2019.circuit.Candidate;
import com.atom.adventofcode.y2019.circuit.Circuit;
...
public class Day3P2 {
    ...
    public void testBoard2() {
        List<Candidate> candidates = Circuit.mapToBoard("R8,U5,L5,D3", "U7,R6,D4,L4");
        assertEquals(30, Circuit.getNearest(candidates, Circuit::steps));

        candidates = Circuit.mapToBoard("R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83");
        assertEquals(610, Circuit.getNearest(candidates, Circuit::steps));

        candidates = Circuit.mapToBoard("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7");
        assertEquals(410, Circuit.getNearest(candidates, Circuit::steps));

    }

    @Test
    public void testPuzzle() {
        List<Candidate> candidates = Circuit.mapToBoard(
        ...
        assertEquals(9238, Circuit.getNearest(candidates, Circuit::steps));
